...
tstart=cputime;
f_ref(1:300,1:300)=0;
Im=imread('\\kc.umkc.edu\kc-users\home\H\hry5g\My Documents\MATLAB\Project\foreman_10frames\f001.pgm');
 f_ref(9:288,9:288)= Im(9:288,9:288);

 srcFiles = dir('\\kc.umkc.edu\kc-users\home\H\hry5g\My Documents\MATLAB\Project\foreman_10frames\*.pgm');
...
SAD=zeros(1,9);
for frameNo=1:9
    filename = strcat('\\kc.umkc.edu\kc-users\home\H\hry5g\My Documents\MATLAB\Project\foreman_10frames\',srcFiles(frameNo+1).name);
     f_2(1:300,1:300)=0;
    Im2= imread(filename);
